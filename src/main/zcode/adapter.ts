...
/** zcode 聚合行 → normalized DailyUsage[](agent 固定为 'zcode') */
export function adaptZcodeRows(rows: ZcodeDailyModelRow[]): DailyUsage[] {
  return rowsToDaily(rows, ZCODE_AGENT, (r) => r.day, toModel)
}
