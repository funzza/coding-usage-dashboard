...
import { detectCcusage, getLastSnapshot, getSessions, refreshUsage } from '../usage/service'
...
import type { QuotaAccount, QuotaAccountConfigView, QuotaProviderId, QuotaSnapshot } from '../quota/types'

export function registerIpcHandlers(getMainWindow: () => BrowserWindow | null): void {
  ipcMain.handle('ccusage:detect', (): Promise<DetectResult> => detectCcusage(true))
  ...
  ipcMain.handle('usage:sessions', (): Promise<SessionsResult> => getSessions())
