...
/** dsh 聚合行 → normalized DailyUsage[](agent 固定为 'dsh') */
export function adaptDshRows(rows: DshDailyModelRow[]): DailyUsage[] {
  return rowsToDaily(rows, DSH_AGENT, (r) => r.day, toModel)
}
