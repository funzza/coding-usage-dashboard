...
import { displayAgentName } from '../utils/agent'
import { resolveBallVisual } from '../utils/ball'
    ...
    <section class="panel">
      ...
      <div class="float-settings">
        <div class="float-controls">
          ...
          <p class="note">
            Hover the ball to see today's usage; click it to open the dashboard. Adaptive color
            follows today's tokens against your historical percentiles.
          </p>
        </div>
