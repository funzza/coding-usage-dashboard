...
export interface SkinDescriptor {
  ...
  swatches: string[]
  /** agent/model 系列调色板(图表、圆点),按名字 hash 稳定取色 */
  series: string[]
}
...
/** 默认系列调色板(classic/focus 共用,保持既有视觉不变) */
...
export const SKINS: SkinDescriptor[] = [
  ...
  },
  {
    ...
    series: ['#8a5a3b', '#5d7341', '#4a6580', '#a05a5a', '#c2953a', '#7a6a9e', '#b8542e', '#6b8a7a', '#c97b7b', '#946d2e']
  },
  {
    id: 'mono',
    name: 'Mono',
    ...
    series: ['#111111', '#3d3d3d', '#666666', '#999999', '#c2c2c2', '#2a2a2a', '#555555', '#808080', '#b0b0b0', '#d6d6d6']
  },
  {
    id: 'neon',
    name: 'Neon',
    ...
    series: ['#00e5ff', '#9d6bff', '#ff2ea6', '#b6ff3c', '#ffc24d', '#4d9fff', '#ff7a5c', '#6dffd8', '#e06bff', '#8bff6b']
  },
  {
    id: 'blueprint',
    name: 'Blueprint',
    ...
    series: ['#6ed0ff', '#ffd23f', '#7be0a3', '#ff8fb8', '#ff9e5c', '#b9a7ff', '#5cd6c0', '#f2e36b', '#8fb8ff', '#ffa8a8']
  }
]
